...
fn test_simple() {
	...
	s := '{"name":"Peter","age":28,"salary":95000.5,"title":"worker"}'
...
fn test_encode_decode_sumtype() {
	...
	enc := '{"title":"Super Mega Game","player":{"name":"Monke","_type":"Human"},"other":[{"tag":"Pen","_type":"Item"},{"tag":"Cookie","_type":"Item"},"cat","Stool",{"_type":"Time","value":${t.unix()}}]}'
